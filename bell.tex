...
\todo{generell im gesamten text: jeden satz auf eine zeile. also nicht im PDF sondern im \LaTeX-Dokument, damit version control besser funktioniert.}
...
\begin{itemize}
    \item Aufgabe A1.1 zu Ziel Z1: Analyse der Strategien zur Generierung der Stämme\todo{Die Aufgaben sind sehr gut identifiziert. Damit können jetzt Kapitel 3 und 4 in Angriff genommen werden.}
...
Es wurde vom Direktor der \ac{W3C}\todo{des Consortiums, oder? Und Komma.} Tim Berners-Lee 1991 entwickelt und ermöglicht den Zugriff auf sowie den Datenaustausch mit \acs{HTML}-Dokumenten.
...
Die erhaltenen Daten werden nun von dem Programm spezifisch für den Verbindungstyp verarbeitet, wie in \cref{sub:Gegenstand} schon erkärt wurde.\todo{erklärt}
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{images/sparql-gen.pdf}
\caption{Die SPARQL-Abfrage im Ablauf.\todo{Sieht gut aus! Bild kann aber ruhig über die ganze Breite gehen. Die SPARQL-Abfrage ist außerdem nur ein Teil des Ablaufes.}}
\label{img:semanticwebstack1}
\end{figure}
...
\caption{Ausgabe der Fragen an den Nutzer.\todo{auch hier würde ich die komplette textbreite ausnutzen, also width=\textbackslash textwidth}}
\label{img:semanticwebstack1}
\end{figure}
