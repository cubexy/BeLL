...
Da die Nutzer möglichst mit logischen, aber nicht zu einfachen Fragen herausgefordert werden sollten, um mithilfe des Multiple-Choice-Quiz ihren Wissensstand zu verbessern, sollte das Quizprogramm bestimmte Vorgaben erfüllen und diese auch in der Qualität der Fragen widerspiegeln. Doch das stellt sich als relativ schwer heraus, da sich die Implementierung von traditioneller Grammatik als relativ umständlich herausstellt. Dadurch ergeben sich einige Probleme, welche sich anhand von Problemen des bereits existenten Quizprogrammes und generelle Probleme dieses Vorhabens in drei Punkte einteilen lassen können:

\begin{itemize}
    \item grammatikalische Korrektheit,
    \item Halten eines bestimmten Levels der Komplexität,
    \item und gleichzeitig eine bestimmte Übersichtlichkeit.
\end{itemize}
