...
\begin{tabular}{llll}
\toprule
p                                                           & label                 & comment                                                                                                     & count \\ \midrule
meta:chapter                    & chapter               & "The subject is a class that is described in a book chapter."@en                                            & 3241  \\
meta:uses                       & uses                  & "The function requires data about the entity type."@en                                                      & 1836  \\
meta:updates                    & updates               & "The subject is a function that updates an entity type."@en                                                 & 1122  \\
meta:isAssociatedWith           & is associated with    & "The most generic relation of SNIK that should only be used if no more specific relation is applicable."@en & 804   \\
meta:entityTypeComponent        & entity type component & "The subject is an entity type that has another entity type as component (part)."@en                        & 631   \\
meta:functionComponent          & function component    & "The subject is a function that has another function as component (part)."@en                               & 479   \\
meta:supports                   & supports              & "A function that an application component supports."@en                                                     & 298   \\
meta:isResponsibleForFunction   & is responsible for    & "is responsible for a function"@en                                                                          & 167   \\
meta:subChapterOf               & subchapter of         & "The subject is a subchapter of a chapter."@en                                                              & 166   \\
meta:isInvolvedIn               & is involved in        &                                                                                                             & 134   \\
meta:isBasedOn                  & is based on           &                                                                                                             & 106   \\
meta:increases                  & increases             & "The subject is a function that increases a measurable entity type."@en                                     & 78    \\
meta:isResponsibleForEntityType & is responsible for    & "is responsible for an entity type"@en                                                                      & 66    \\
meta:roleComponent              & role component        & "The subject is a role that has another role as component (part)."@en                                       & 42    \\
meta:approvesEntityType         & approves              & "The role approves the entity type or can potentially approve it."@en                                       & 41    \\
meta:master                     & master                & "The object is an application component which is responsible for the entity type subject."@en               & 24    \\
meta:decreases                  & decreases             & "The subject is a function that decreases a measurable entity type."@en                                     & 17    \\
meta:communicatesWith           & communicates with     & "The subject is an application component that communicates with another application component."@en          & 12    \\
meta:approvesFunction           & approves              & "The role approves the Function or can potentially approve it."@en                                          & 1     \\
meta:isResponsibleForRole       & is responsible for    & "is responsible for a role"@en                                                                              & 1     \\ \bottomrule
\end{tabular}
\end{table}
\end{comment}
