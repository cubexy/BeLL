...
(
?class a owl:Class.
Sei ?class ein Attribut des Typus Klasse
?class rdfs:label ?cl.
...
Um das Beispiel \enquote{Skateboard} verständlich zu halten, habe ich mich hier anstelle der SNIK-Ontologie auf Wikidata bezogen.
...
\midrule
Boot										&Lastkraftwagen\\
\textcolor{green}{Skateboard}			&Citybike\\
\bottomrule
\end{tabularx}
\end{centering}
\caption{Beispielausgabe der DEFINITION-Query.}
