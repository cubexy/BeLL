...
RDF ist ein Standartmodell fuer den Datenaustausch im Web.
%Es erweitert die  Verknuepfungsstruktur
von diesem%, um URIs (Universal Resource Identifier) einzubinden.
URIs werden im semantischen Netz dazu genutzt, Beziehungen zwischen Dingen beziehungsweise zwischen den beiden Enden der Verknuepfung herzustellen, um Dateien zu verknuepfen, verfuegbar zu machen und für Anwendungen freizugeben.
